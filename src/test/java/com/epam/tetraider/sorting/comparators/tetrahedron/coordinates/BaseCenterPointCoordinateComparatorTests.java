...
public class BaseCenterPointCoordinateComparatorTests {
    ...
    public void testCompareShouldReturnOneWhenFirstGreaterThenSecond() {
        ...
        Comparator<NumberedTetrahedron> tetrahedronComparator = new BaseCenterPointCoordinateComparator(pointComparator);
