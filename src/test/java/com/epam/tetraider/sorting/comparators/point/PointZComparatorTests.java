...
public class PointZComparatorTests {
    private static final Point TWO_POINT = new Point(0, 0, 2);
    private static final Point ONE_POINT = new Point(0, 0, 1);
    ...
    public void testCompareShouldReturnOneWhenFirstGreaterThenSecond() {
        // given
        Comparator<Point> pointComparator = new PointZComparator();
